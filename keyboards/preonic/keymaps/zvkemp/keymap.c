...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  MT(MOD_LCTL, KC_ESC),KC_A,KC_S,KC_D,KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, LT(_NAV, KC_QUOT), \
...
[_COLEMAK] = LAYOUT_preonic_grid( \
  ...
  MT(MOD_LCTL, KC_ESC),KC_A,KC_R,KC_S,KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    LT(_NAV, KC_QUOT), \
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_BSPC, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, _______, _______, KC_UNDS, KC_PLUS, _______, _______, KC_PIPE, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  KC_DEL,  KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, _______, _______, KC_MINS,  KC_EQL, _______, _______, KC_BSLS, \
